...
class RecipeCard extends HTMLElement {
	...
	set data(data) {
		...
		const titleLnk = document.createElement('a');
		titleLnk.href = data.titleLnk;
		titleLnk.innerHTML = data.titleTxt;
		title.append(titleLnk);
		...
		rating.append(span1, ratingImg, span2);
		...
		article.append(img, title, org, rating, time, ingredients);
	}
}
